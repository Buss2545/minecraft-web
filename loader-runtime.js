...
(function (root) {
  ...
  function render(el, cfg, opts) {
    ...
    set('.mlx-title', cfg.title);
    set('.mlx-sub', cfg.subtitle);
    set('.mlx-tag', cfg.tag);
    if (!cfg.title) el.querySelector('.mlx-title').classList.add('mlx-hide');
    if (!cfg.subtitle) el.querySelector('.mlx-sub').classList.add('mlx-hide');
    if (!cfg.showBar) el.querySelector('.mlx-bar').classList.add('mlx-hide');
    if (!cfg.showBar && !cfg.tag) el.querySelector('.mlx-meta').classList.add('mlx-hide');
